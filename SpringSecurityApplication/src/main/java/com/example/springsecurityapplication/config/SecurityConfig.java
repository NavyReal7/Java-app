...
//                .anyRequest().authenticated()
                .requestMatchers("/authentication", "/registration", "/error", "/resources/**", "/static/**", "/css/**", "/js/**", "/img/**", "/product", "/product/info/{id}", "/product/search").permitAll()                                                                               //страница должна быть доступна любому пользователю, не вошедшему в систему!
                                                                        //инф. о товаре должна быть доступна любому пользователю, не вошедшему в систему!
                                                          //страница "/product" должна быть доступна любому пользователю, не вошедшему в систему!
